...
import 'package:flutter_sixvalley_ecommerce/features/prediction/domain/repositories/prediction_repository.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/botcenter/domain/repositories/bot_repository.dart';
import 'package:flutter_sixvalley_ecommerce/features/botcenter/domain/repositories/bot_repository_interface.dart';
import 'package:flutter_sixvalley_ecommerce/features/botcenter/domain/services/bot_service.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<PredictionRepositoryInterface>(() => PredictionRepository(dioClient: sl()));
  sl.registerLazySingleton<AdRepositoryInterface>(() => AdRepository(dioClient: sl()));
  sl.registerLazySingleton<AdServiceInterface>(() => AdService(adRepository: sl()));
  sl.registerLazySingleton<BotRepositoryInterface>(() => BotRepository(dioClient: sl()));
  sl.registerLazySingleton<BotServiceInterface>(() => BotService(botRepository: sl()));
  ...
  sl.registerFactory(() => PredictionController(predictionRepo: sl()));
  sl.registerFactory(() => AdController(adService: sl()));
  sl.registerFactory(() => BotController(botService: sl(), sharedPreferences: sl()));
