    ...
    return Scaffold(
      ...
      body: Consumer<LocationController>(
          builder: (context, locationController, child) {
            // ملاحظة: تم إزالة شرط mapApiStatus == 1 لضمان ظهور الخريطة إذا كانت المكتبة مثبتة
            return Stack(clipBehavior: Clip.none, children: [
              GoogleMap(
                mapType: MapType.normal,
                initialCameraPosition: CameraPosition(
                    target: LatLng(locationController.position.latitude != 0 ? locationController.position.latitude : 15.3694, 
                                 locationController.position.longitude != 0 ? locationController.position.longitude : 44.1910), 
                    zoom: 16),
                  ...
                  child: Row(
                    children: [
                      ...
                      '${locationController.pickAddress?.name ?? ''} ${locationController.pickAddress?.subAdministrativeArea ?? ''} '
                          ...
                          : getTranslated('search_location', context)!, maxLines: 1, overflow: TextOverflow.ellipsis)),
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(width: 50, height: 50,
                          ...
                          color: Theme.of(context).cardColor, boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 5)]),
                    ...
                    SizedBox(width: double.infinity,
                      child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                        child: CustomButton(buttonText: getTranslated('select_location', context),
                          onTap: () {
                            // تم إصلاح المنطق هنا ليتم الحفظ في كل الحالات
