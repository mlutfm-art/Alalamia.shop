  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(AppConstants.appName,style: textBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).primaryColor)),
        Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
            child: Text(AppConstants.slogan,style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor)))]),
