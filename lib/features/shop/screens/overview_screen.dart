...
class ShopOverviewScreen extends StatefulWidget {
  ...
  const ShopOverviewScreen({super.key, required this.sellerId, required this.scrollController, this.sellerNavigationModel});
          ...
          builder: (context, couponController, _) {
            return  Column(
              ...
              children: [
                ...
                ClearanceShopListWidget(sellerId: widget.sellerId.toString(), isHomeScreen: false, sellerNavigationModel: widget.sellerNavigationModel),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Consumer<SellerProductController>(
                  builder: (context, productController, _) {
                    return Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeSmall,
                      ...
                      child: ShopFeaturedProductViewList(scrollController: widget.scrollController, sellerId: widget.sellerId, sellerNavigationModel: widget.sellerNavigationModel));
                  }
                ),
