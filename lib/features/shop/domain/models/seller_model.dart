...
class Seller {
  ...
  Seller.fromJson(Map<String, dynamic> json) {
    ...
    posStatus = int.tryParse(json['pos_status'].toString());
    minimumOrderAmount = double.tryParse(json['minimum_order_amount'].toString());
    freeDeliveryStatus = double.tryParse(json['free_delivery_status'].toString());
    freeDeliveryOverAmount = double.tryParse(json['free_delivery_over_amount'].toString());
