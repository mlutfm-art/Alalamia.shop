...
class ShopRecommandedProductViewList extends StatefulWidget {
  ...
  const ShopRecommandedProductViewList({super.key, required this.scrollController, required this.sellerId, this.sellerNavigationModel});
              ...
              itemView: RepaintBoundary(
                child: MasonryGridView.count(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ProductWidget(productModel: productController.sellerWiseRecommendedProduct!.products![index], sellerNavigationModel: widget.sellerNavigationModel);
                  },
                ),
