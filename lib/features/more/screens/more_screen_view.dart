                        ...
                        return Padding(padding:  const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Container(padding:  const EdgeInsets.all(Dimensions.paddingSizeSmall),
                            ...
                            child: Column(children: [
                              ...
                              // إضافة زر التوقعات هنا
                              MenuButtonWidget(
                                icon: Icons.sports_soccer, // استخدام أيقونة كرة قدم
                                title: "مركز التوقعات", 
                                isProfile: true,
                                onTap: () {
                                  RouterHelper.getPredictionHubRoute(action: RouteAction.push);
                                },
                              ),
                      ...
                      child: Consumer<SplashController>(
                        builder: (context, splashController, _){
                          return Column(children: [
                            ...
                            MenuButtonWidget(image: Images.offerIcon, title: getTranslated('offers', context),
                              onTap: () {
