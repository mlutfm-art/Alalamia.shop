...
class AsterThemeHomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload) async {
    ...
    flashDealController.getFlashDealList(reload, true);

    // FIX 2: Prediction data loading
    ...
    return Scaffold(resizeToAvoidBottomInset: false,
      body: SafeArea(child: RefreshIndicator(
        ...
        child: CustomScrollView(controller: _scrollController, slivers: [
          ...
          const SliverToBoxAdapter(child: PredictionBannerWidget()),
                  ...
                  Column(children: [
                    Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                      child: ValueListenableBuilder<Duration?>(
                        valueListenable: megaDeal.durationNotifier,
          ...
          SliverToBoxAdapter(
            ...
            SliverToBoxAdapter(
              child: FooterBannerSliderWidget(),
            ),
            SliverToBoxAdapter(child: SizedBox(height: Dimensions.paddingSizeDefault)),
