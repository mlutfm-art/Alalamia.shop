    ...
    return Selector<ProductController, ProductModel?>(
      ...
      return (featuredProductModel?.products?.isNotEmpty ?? false)  ? ColoredBox(
        ...
        child: Column(children: [
          ...
          SizedBox(
            height: ResponsiveHelper.isTab(context)? MediaQuery.of(context).size.width * .58 : 305,
      ...
      ) : (featuredProductModel == null && !Provider.of<ProductController>(context, listen: false).filterApply) ? 
          const SliderProductShimmerWidget() : const SizedBox.shrink();
    });
  }
}
