                            ...
                            SafeArea(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // الصف الثاني: أيقونة السلة وزر الدفع
                                  Row(
                    ...
                    body: Column(children: [
                      ...
                      Column(
                        children: [
                                                          ...
                                                          child: Container(decoration: BoxDecoration(
                                                            ...
                                                            child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                                ...
                                                                const SizedBox(width: 15, child: Icon(Icons.keyboard_arrow_down, color: Colors.grey)),
                                                                const SizedBox(width: Dimensions.paddingSizeExtraSmall)
                                                              ]),
                                                            ),
                                                          ),
                          ...
                          if(sellerGroupList.isNotEmpty && sellerGroupList[0].freeDeliveryOrderAmount?.status == 1 && CartHelper().hasPhysical(cartProductList) && sellerGroupList[0].isGroupItemChecked! && singleVendor)
                            Container(
                              padding: const EdgeInsets.fromLTRB(
