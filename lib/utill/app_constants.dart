...
class AppConstants {
  static const String appName = 'متجر العالمية';
  static const String slogan = 'جمالك جمال .. مش فلتر';
  ...
  static const String baseUrl = 'https://alalamia.shop';

  static const String googleServerClientId = '771867184256-5csq7gblrbqp3nduh0d1t0n1j1hbmfp9.apps.googleusercontent.com';
  static const String mapApiKey = 'AIzaSyA9bKnmKadDufyxap_Fn-q6_fmWKtc7hGA';
  ...
  // Prediction Contest
  static const String activeMatchUri = '/api/v1/predictions/matches/active';
  static const String submitPredictionUri = '/api/v1/predictions/submit';
  static const String leaderboardUri = '/api/v1/predictions/leaderboard';
  static const String myPredictionsUri = '/api/v1/predictions/my-predictions';
  static const String predictionBannerUri = '/api/v1/predictions/banner';
  ...
  static const String smartAdsNotificationsUri = '/api/v1/smartads/notifications';
